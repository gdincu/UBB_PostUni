...
// Insereaza elementele sortate inpaoi in matrice
for(_a=0;_a<count;_a++)	
		for(_b=0;_b<count;_b++)
		{
		if(_a==_b) 
			{
			vector[_a][_b].nume_membru_1=sort_diag1[_b].nume_membru_1;
			vector[_a][_b].nume_membru_2=sort_diag1[_b].nume_membru_2;
			}
		}
...
// Insereaza elementele sortate inapoi in matrice
for(_a=count;_a>=0;_a--)	
		for(_b=count;_b>=0;_b--)
		{
		if(_a+_b==count-1) 
			{
			vector[_b][_a].nume_membru_1=sort_diag2[count-_b-1].nume_membru_1;
			vector[_b][_a].nume_membru_2=sort_diag2[count-_b-1].nume_membru_2;
			}
		}


// Afiseaza matricea dupa sortare
printf("\n\nMatricea dupa sortare este:\n\n");
for(_a=0;_a<count;_a++)
	{	
		for(_b=0;_b<count;_b++)
		{
