...
public class MainController {
    ...
    public void DrugUndo(ActionEvent actionEvent) {
        drugService.undo();
        drug.clear();
        drug.addAll(drugService.getAll());
    }

    public void DrugRedo (ActionEvent actionEvent) {
        drugService.redo();
        drug.clear();
        drug.addAll(drugService.getAll());
    }
    ...
    public void ClientUndo(ActionEvent actionEvent) {
        clientService.undo();
        client.clear();
        client.addAll(clientService.getAll());
    }

    public void ClientRedo (ActionEvent actionEvent) {
        clientService.redo();
        client.clear();
        client.addAll(clientService.getAll());
    }
    ...
    public void TransactionUndo(ActionEvent actionEvent) {
        transactionService.undo();
        transaction.clear();
        transaction.addAll(transactionService.getAll());
    }

    public void TransactionRedo (ActionEvent actionEvent) {
